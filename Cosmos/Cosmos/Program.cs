...
namespace Cosmos
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int valik = 0;
            int count = 1;
            int rng1, result, temp1, temp2, level;
            string hmm;
//
//MENU
//
...
//
            ...
            L1:
                ...
                if (result == Program.RngMain1(temp1, temp2))
                {
                ...
                {
                    Console.Clear();
                    Console.WriteLine("Oi Oi, proovi uuesti!\n\nÕige vastus oleks olnud {0}", Program.RngMain1(temp1, temp2));
                    Console.ReadKey();
                    goto L1;
                }
                //
...
//
            ...
            L3:
                ...
                Console.WriteLine("{0} - {1} =__", temp1, temp2);
                result = int.Parse(Console.ReadLine());
                if (result == Program.RngMain2(temp1, temp2))
                {
                    Console.WriteLine("Õige vastus! {0}/5", count++);
                    if (count <= 5)
                    {
                ...
                {
                    Console.Clear();
                    Console.WriteLine("Oi Oi, proovi uuesti!\n\nÕige vastus oleks olnud {0}", Program.RngMain2(temp1, temp2));
                    Console.ReadKey();
                    goto L3;
                }
                //
...
//
            ...
            L6:
                ...
                Console.WriteLine("{0} * {1} =__", temp1, temp2);
                result = int.Parse(Console.ReadLine());
                if (result == Program.RngMain3(temp1, temp2))
                {
                    Console.WriteLine("Õige vastus! {0}/5", count++);
                    if (count <= 5)
                    {
                ...
                {
                    Console.Clear();
                    Console.WriteLine("Oi Oi, proovi uuesti!\n\nÕige vastus oleks olnud {0}", Program.RngMain3(temp1, temp2));
                    Console.ReadKey();
                    goto L6;
                }
                //
